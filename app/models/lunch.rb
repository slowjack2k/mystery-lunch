class Lunch < ApplicationRecord
  ...
  def add_to_different_lunchgroup(participation)
    current_pairing = pairs

    current_pairing.delete participation.lunch_group

    all_different_department = proc { |participants| participants.all? { |employee| employee.department != participation.employee.department } }
